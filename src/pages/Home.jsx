...
//     navigateTo('browse', filters);
//   };

//   const handleToggleWishlist = async (bookId) => {
//     // Will be implemented with full wishlist functionality
...
//             </button>
//             <button className="btn btn-gold" onClick={() => navigateTo('post')}>
...
//           </h2>
//           <span className="text-muted" style={{ fontSize: '0.85rem', cursor: 'pointer' }} onClick={() => navigateTo('browse')}>
//             {lang === 'ar' ? 'عرض الكل' : 'View all'}
//           </span>
//         </div>
//         <div className="majors-grid">
//           {MAJORS.slice(0, 12).map(m => (
//             <div key={m.key} className="major-chip" onClick={() => navigateTo('browse', { major: m.key })}>
