    ...
    return (
      <div key={book.id} className="book-card" style={{ cursor: 'default' }}>
        ...
        <div style={{ display: 'flex', gap: '3px', marginTop: '6px' }}>
          <button className="btn btn-outline btn-xs" onClick={() => navigate(`/post?id=${book.id}`)}>
  ...
  return (
    <div className="container" style={{ paddingTop: '20px', paddingBottom: '20px' }}>
      ...
      <div className="profile-tabs">
        ...
        <button className="btn btn-outline btn-sm" onClick={() => navigate('/post')}>
      ...
      <div className="book-grid">
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <a onClick={() => navigate('/post')} style={{ color: 'var(--gold)', cursor: 'pointer', display: 'block', marginTop: '8px' }}>
