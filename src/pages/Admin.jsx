...
// function Admin() {
//   const { lang, currentAdmin, logout } = useAuth();
...
//             <button className="btn btn-outline btn-sm" onClick={() => window.location.hash = 'home'}>
...
//     // The login logic is in AuthContext
//     setLoading(true);
//     // The actual login will be triggered via the parent
//     setLoading(false);
//   };
